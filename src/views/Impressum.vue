<template>
  <b-card title="Impressum">
    <div class="text-muted">
      <div>
        Andreas Stephan
      </div>
      <div>
        cafe.serendipity2121@gmail.com
      </div>
    </div>
    <h6 class="mt-4">Haftung für Inhalte</h6>
    ...
    <h6 class="mt-4">Haftung für Links</h6>
    ...
    <h6 class="mt-4">Google Analytics</h6>
    ...
    <div slot="footer" class="text-center">
      <b-button :to="{ name: 'home' }" variant="outline-warning"
        >zurück</b-button
      >
    </div>
  </b-card>
